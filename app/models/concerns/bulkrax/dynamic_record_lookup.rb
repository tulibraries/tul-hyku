  ...
  module DynamicRecordLookup
    ...
    def find_record(identifier, importer_run_id = nil)
      ...
      begin
        ...
        record = Bulkrax::Entry.find_by(default_scope.merge({ importerexporter_id: importer_id })) || Entry.find_by(default_scope)
      ...
      record.is_a?(Bulkrax::Entry) ? [record, record.factory.find] : [nil, record]
    end
